      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:8 py-12 pt-24">
            ...
            <div className="prose max-w-none mb-8">
              ...
              <p className="text-blue-600 font-semibold mt-2">
                {userPlatform.includes('mac') 
                  ? '**Important: Right-click the app and select "Open" (don\'t double-click)'
                  : '** Click the download button to open GitHub Releases in a new tab'
                }
              </p>
              
              {/* Direct GitHub Releases Button */}
              <div className="mt-6">
                <button
                  onClick={() => window.open('https://github.com/danrublop/I-can-t-code-translator/releases', '_blank')}
                  className="inline-flex items-center bg-black hover:bg-gray-800 text-white font-bold text-lg py-5 px-10 rounded-lg transition-colors shadow-lg hover:shadow-xl"
                >
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-6">
            ...
            <a href="https://github.com/danrublop/I-can-t-code-translator" className="text-black hover:text-gray-800 font-medium">
              GitHub
            </a>
          </div>
        </div>
